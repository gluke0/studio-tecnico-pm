...
<template>
    ...
    <div class="container d-flex justify-content-center">
        <div class="services">
            ...
            <div class="box-service">
                <h4 class="text-uppercase">stampi</h4>
                <span class="single-service">
            ...
            <div class="box-service">
                <h4 class="text-uppercase">reverse engineering</h4>
                <span class="single-service">
                    Ricostruzione file 3D a partire da digitalizzazione di oggetti con Scanner 3D 
                </span>
            </div>
            <div class="box-service">
                <h4 class="text-uppercase">lavorazioni meccaniche di precisione</h4>
